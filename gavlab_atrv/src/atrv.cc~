                        ...
                        double &x, double &y, double &theta)
{
  ...
  left_wheel_speed /= 4000.0f;
  right_wheel_speed /= 4000.0f;
  ...
  velocity += right_wheel_speed;
  velocity += left_wheel_speed;
  velocity /= 2.0f;
  double angular_velocity = 0.0f;
  angular_velocity -= (1/track_width_) * left_wheel_speed;
  angular_velocity += (1/track_width_) * right_wheel_speed;
